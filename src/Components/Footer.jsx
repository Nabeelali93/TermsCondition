    ...
    <clipPath id="clip0_1_286">
      ...
      <div className="lg:w-1/5 md:w-1/3 w-full  md:px-0 lg:px-0 px-3 ">
        ...
        <ul className="list-none mb-10 ">
          ...
          <li className='my-3'>
            <a onClick={privacyPolicy} className="text-[#c1c1c1] cursor-pointer">Privacy policy</a>
          </li>
          <li className='my-3'>
            <a onClick={termcondition} className="text-[#c1c1c1] cursor-pointer">Term of use</a>
          </li>
          <li className='my-3'>
            <a onClick={helpcenter} className="text-[#c1c1c1] cursor-pointer">Blogs</a>
          </li>
        </ul>
      </div>
      <div className="lg:w-1/5 md:w-1/3 w-full  md:px-0 lg:px-0 px-3">
