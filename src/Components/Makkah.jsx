...
function Makkah() {
 ...
 const [traveldateModal, settraveldateModal] = useState(false);
          ...
          <div className="container flex  px-5 py-10 mx-auto">
            <div className="flex flex-wrap justify-evenly -m-2">
              <div className="p-2 md:h-[60px] md:w-[230px] h-16 w-60 ">
                <div
                  onClick={() => settraveldateModal(true)}
                  className="h-full flex items-center cursor-pointer  border p-4 bg-white rounded-lg hover:bg-gray-50 active:bg-gray-100"
                >
                      ...
                      <g id="calendar-date-schedule-svgrepo-com 1">
                        <g id="SVGRepo_iconCarrier">
                          <g id="Group">
                            <path
                              id="Vector"
                              d="M18.2181 16.5732H15.0629C14.795 16.5732 14.5781 16.7403 14.5781 16.9469V19.379C14.5781 19.5853 14.795 19.7527 15.0629 19.7527H18.2181C18.4861 19.7527 18.7029 19.5853 18.7029 19.379V16.9469C18.7029 16.7406 18.4861 16.5732 18.2181 16.5732ZM17.7333 19.0053H15.5478V17.3206H17.7333V19.0053Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
                            <path
                              id="Vector_2"
                              d="M25.5769 16.5732H22.4217C22.1538 16.5732 21.9369 16.7403 21.9369 16.9469V19.379C21.9369 19.5853 22.1538 19.7527 22.4217 19.7527H25.5769C25.8445 19.7527 26.0617 19.5853 26.0617 19.379V16.9469C26.0617 16.7406 25.8445 16.5732 25.5769 16.5732ZM25.0921 19.0053H22.9065V17.3206H25.0921V19.0053Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
                            <path
                              id="Vector_3"
                              d="M32.7088 16.5732H29.5537C29.286 16.5732 29.0688 16.7403 29.0688 16.9469V19.379C29.0688 19.5853 29.286 19.7527 29.5537 19.7527H32.7088C32.9765 19.7527 33.1937 19.5853 33.1937 19.379V16.9469C33.1937 16.7406 32.9765 16.5732 32.7088 16.5732ZM32.224 19.0053H30.0385V17.3206H32.224V19.0053Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
                            <path
                              id="Vector_4"
                              d="M18.2181 22.1131H15.0629C14.795 22.1131 14.5781 22.2805 14.5781 22.4868V24.9189C14.5781 25.1252 14.795 25.2926 15.0629 25.2926H18.2181C18.4861 25.2926 18.7029 25.1252 18.7029 24.9189V22.4868C18.7029 22.2805 18.4861 22.1131 18.2181 22.1131ZM17.7333 24.5452H15.5478V22.8605H17.7333V24.5452Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
                            <path
                              id="Vector_5"
                              d="M25.5769 22.1131H22.4217C22.1538 22.1131 21.9369 22.2805 21.9369 22.4868V24.9189C21.9369 25.1252 22.1538 25.2926 22.4217 25.2926H25.5769C25.8445 25.2926 26.0617 25.1252 26.0617 24.9189V22.4868C26.0617 22.2805 25.8445 22.1131 25.5769 22.1131ZM25.0921 24.5452H22.9065V22.8605H25.0921V24.5452Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
                            <path
                              id="Vector_6"
                              d="M32.7088 22.1131H29.5537C29.286 22.1131 29.0688 22.2805 29.0688 22.4868V24.9189C29.0688 25.1252 29.286 25.2926 29.5537 25.2926H32.7088C32.9765 25.2926 33.1937 25.1252 33.1937 24.9189V22.4868C33.1937 22.2805 32.9765 22.1131 32.7088 22.1131ZM32.224 24.5452H30.0385V22.8605H32.224V24.5452Z"
                              fill="#699FC9"
                              stroke="#699FC9"
                              strokeWidth="0.00159473"
                            />
              ...
              <div className="p-2 md:h-[60px] md:w-[230px] h-16 w-60 ">
                <div
                  onClick={() => setreturnCalenderModal(true)}
                  className="h-full flex items-center  border p-4  hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg"
                >
                  <div className="   flex justify-center mr-4 ">
                    <svg
                      width="48"
                    ...
                    >
                      <g id="city-svgrepo-com (3) 1">
                        <g id="SVGRepo_iconCarrier">
                          <path
                            id="Vector"
                            d="M12.25 12H12.2675M12.25 17.3333H12.2675M12.25 22.6667H12.2675M26.25 9.33333H26.2675M26.25 14.6667H26.2675M26.25 20H26.2675M31.5 18.6667H31.5175M31.5 24H31.5175M15.75 6.66667H7C6.03351 6.66667 5.25 7.26363 5.25 8V26.6667C5.25 27.4031 6.03351 28 7 28H15.75M21 6.13333V25.8667C21 26.6135 21 26.9868 21.1908 27.272C21.3586 27.5229 21.6261 27.7268 21.9555 27.8547C22.3298 28 22.8198 28 23.8 28H33.95C34.9302 28 35.4202 28 35.7945 27.8547C36.1239 27.7268 36.3914 27.5229 36.5593 27.272C36.75 26.9868 36.75 26.6135 36.75 25.8667V15.3333C36.75 14.7121 36.75 14.4015 36.6168 14.1564C36.4392 13.8297 36.0985 13.5701 35.6697 13.4348C35.3481 13.3333 34.9403 13.3333 34.125 13.3333C33.3097 13.3333 32.9019 13.3333 32.5803 13.2318C32.1515 13.0965 31.8108 12.8369 31.6332 12.5102C31.5 12.2652 31.5 11.9546 31.5 11.3333V6.13333C31.5 5.3866 31.5 5.01323 31.3093 4.72801C31.1414 4.47713 30.8739 4.27316 30.5445 4.14532C30.1702 4 29.6802 4 28.7 4H23.8C22.8198 4 22.3298 4 21.9555 4.14532C21.6261 4.27316 21.3586 4.47713 21.1908 4.72801C21 5.01323 21 5.3866 21 6.13333Z"
                            stroke="#699FC9"
                            strokeWidth="1.932"
                            strokeLinecap="round"
              ...
              <div className="p-2 md:h-[60px] md:w-[250px] h-16 w-60">
                <div
                  ...
                  className="h-full flex items-center  border px-3.5 hover:bg-gray-50 active:bg-gray-100 cursor-pointer bg-white rounded-lg"
                >
                    ...
                    >
                      ...
                      >
                        <g id="SVGRepo_iconCarrier">
                          ...
                          <path
                            id="Vector_3"
                            d="M22.375 19.7784H19.125V16.5928H17.5V19.7784H14.25V21.3713H17.5V24.5569H19.125V21.3713H22.375V19.7784Z"
                            fill="#699FC9"
                            stroke="#699FC9"
                            strokeWidth="0.000444853"
                          />
                          <path
                            id="Vector_4"
                            d="M12.6255 37.2996H4.31171C3.9537 37.2993 3.6058 37.1832 3.32191 36.9694C3.03802 36.7556 2.83401 36.456 2.74147 36.117L-0.347656 24.7621L1.22258 24.3518L4.31171 35.7067H12.6255V37.2996Z"
                            fill="#699FC9"
                            stroke="#699FC9"
                            strokeWidth="0.000444853"
                          />
...
<select required className="appearance-none outline-none">
                      <option value="" selected disabled>
                      Nights in Mecca
                      </option>

                      <option value="a-value-here">1 Nights</option>
                      <option value="a-value-here">2 Nights</option>
                      <option value="a-value-here">3 Nights</option>
                      <option value="a-value-here">4 Nights</option>
                      <option value="a-value-here">5 Nights</option>
                      <option value="a-value-here">6 Nights</option>
                      <option value="a-value-here">7 Nights</option>
                      <option value="a-value-here">8 Nights</option>
                      <option value="a-value-here">9 Nights</option>
                      <option value="a-value-here">10 Nights</option>
                     </select>
              ...
              <div className="p-2 md:h-[60px] md:w-[235px] h-16 w-60">
        ...
        <div className="md:ml-0 ml-5">
          <section className="text-gray-600 body-font">
            <div className="container px-5 py-6 mx-auto">
              <div className="flex flex-wrap -m-4 justify-center md:p-[20px]">


                <div style={{height:900+"px"}} className="p-4 sm:w-1/4    bg-[#E4F0FF] ">
                  <div className="inline">
                    ...
                    <h1 className="md:px-5 px-0  md:text-2xl text-lg font-normal">Price</h1>

                    <h1 className="md:px-5 px-0 py-2 text-[#A5A5A5] text-sm font-normal">
                      Rs 15,000 -Rs 20,000{" "}
                    </h1>
                    ...
                    <h1 className="md:px-5 px-0 md:text-1xl text-lg font-normal">DISTANCE</h1>

                    <h1 className="md:px-5 px-0 p-3 text-[#A5A5A5] text-sm font-normal">
                      1000M-300M{" "}
                    </h1>
                    ...
                    <h1 className="md:px-5 px-0 md:text-2xl text-lg font-normal">ROOM TYPE</h1>

                    <div className="flex  flex-wrap py-3 md:px-3.5 px-0">
                      <label
                    ...
                    <h1 className="md:px-0 px-0 md:text-xl text-sm  ">SAHRED TOTAL BED</h1>

                    <select className="md:px-0   w-full md:w-[130px] sm:w-[120px] px-0  py-3 bg-transparent" required>
                      <option  selected disabled>5 BED ROOM</option>
...
<div className="w-3/4 inline-flex float-right justify-center">
...
<section className="text-gray-600 body-font">
<h1 className=" font-bold px-5 py-8 md:text-left text-center text-2xl">Hotel NIGHTS IN Makkah</h1>

  <div className="container px-5 py-24 mx-auto">

    <div className="flex flex-wrap -mt-28 -m-4">
  ...
  <div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
      ...
      <div className="flex flex-wrap items-center mt-5 justify-between">
        ...
        <button onClick={()=>cardDetails()} className="inline-flex  items-center px-2 py-1 text-sm font-medium text-center text-white bg-[#699FC9]  rounded-lg hover:bg-[#5386ad] focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 ">
          Select Now
        </button>
      </div>
    </div>
            ...
            <div className="relative w-auto  mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-2 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-semibold">Date of Travel</h3>
                  <button
                    className="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
                    onClick={() => settraveldateModal(false)}
                  >
          ...
          <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                {/*header*/}
                <div className="flex items-start justify-between p-2 border-b border-solid border-blueGray-200 rounded-t">
                  <h3 className="text-3xl font-semibold">Return Date</h3>
                  <button
                    className="p-1 ml-auto bg-transparent border-0 text-black opacity-5 float-right text-3xl leading-none font-semibold outline-none focus:outline-none"
